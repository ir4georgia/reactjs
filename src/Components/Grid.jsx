...
// import gridImage from '../images/ifgeorgiafights.jpg'
...
class Grid extends Component {
    ...
    componentDidMount() {
        this.setState({
            data: [
                { name: "Michael", age: 57, job: "Technical Publisher Support Specialist" },
            ...
            fields: [
                ...
                { name: 'age', displayName: "Age", inputFilterable: true, exactFilterable: false, sortable: true },
                { name: 'job', displayName: "Occupation", inputFilterable: true, exactFilterable: false, sortable: true }
            ]
        })
    }
    render() {
